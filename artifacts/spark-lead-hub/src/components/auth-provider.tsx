      ...
      {showWarning && !!token && (
        <div style={{
          ...
          <div style={{
            ...
            padding: "var(--space-8)",
            width: 360,
            boxShadow: "0 24px 64px hsl(222 22% 3% / 0.6), 0 0 0 1px hsl(220 90% 60% / 0.08)",
            textAlign: "center",
            display: "flex",
            ...
            <div style={{
              ...
              background: countdown <= 10
                ? "hsl(0 72% 51% / 0.12)"
                : "hsl(220 90% 60% / 0.1)",
              border: `2px solid ${countdown <= 10 ? "hsl(0 72% 51% / 0.5)" : "hsl(220 90% 60% / 0.4)"}`,
            ...
            <div style={{ display: "flex", gap: "var(--space-3)", width: "100%" }}>
              <button
                ...
                style={{
                  flex: 1, height: 42,
                  background: refreshing ? "hsl(220 90% 60% / 0.5)" : "var(--teal)",
                  color: "hsl(222 22% 6%)",
                  border: "none",
