    ...
    <div ref={ref} style={{ position: "relative", flexShrink: 0, width }}>
      <button
        ...
        style={{
          ...
          background: isActive ? "hsl(220 90% 60% / 0.06)" : "var(--bg-subtle)",
          border: open
            ? "1px solid var(--teal)"
            : isActive
            ? "1px solid hsl(220 90% 60% / 0.4)"
          ...
          gap: "var(--space-2)",
          boxShadow: open ? "0 0 0 3px hsl(220 90% 60% / 0.12), 0 0 8px hsl(220 90% 60% / 0.15)" : "none",
      ...
      {open && (
        <div style={{
          ...
          zIndex: 200,
          overflow: "hidden",
          boxShadow: "0 8px 32px hsl(222 22% 3% / 0.5), 0 0 0 1px hsl(220 90% 60% / 0.08)",
        }}>
          {searchable && (
            <div style={{
