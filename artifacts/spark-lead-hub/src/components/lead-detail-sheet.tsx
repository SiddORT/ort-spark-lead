            ...
            <div className="timeline-action">
              {a.action === "note_added" ? (
                <>
                  ...
                  {a.noteContent && (
                    <div style={{ marginTop: 6, padding: "6px 10px", background: "hsl(220 20% 10%)", borderLeft: "2px solid hsl(220 90% 60% / 0.4)", borderRadius: "0 4px 4px 0", fontSize: "var(--text-xs)", color: "var(--text-secondary)", fontStyle: "italic", lineHeight: 1.5 }}>
                      "{a.noteContent}"
                    </div>
                  )}
                  {a.newValue && (
            ...
            {lead && (
              <div className="sheet-lead-meta">
                ...
                {(() => {
                  ...
                  const border= isOverdue ? "hsl(0 80% 58% / 0.25)" : isToday ? "hsl(45 95% 55% / 0.25)" : "hsl(220 90% 60% / 0.35)";
