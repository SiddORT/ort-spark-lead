    ...
    <div style={{
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", zIndex: 0 }}>
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, hsl(220 90% 60% / 0.10) 0%, transparent 70%)",
        }} />
        <div style={{
          position: "absolute", top: "-80px", left: "-80px",
          width: 360, height: 360,
          background: "radial-gradient(ellipse at center, hsl(220 90% 60% / 0.09) 0%, transparent 70%)",
        }} />
        <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 460, position: "relative", zIndex: 1, animation: "authFadeIn 0.4s ease both" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{
            ...
            borderRadius: "var(--radius-lg)",
            marginBottom: 14,
            boxShadow: "0 0 20px hsl(220 90% 60% / 0.18)",
          }}>
        ...
        {submitted ? (
          ...
          <div style={{ ...glassCard, textAlign: "center", animation: "authFadeIn 0.3s ease both" }}>
            <div style={{
              ...
              borderRadius: "50%",
              margin: "0 auto 20px",
              boxShadow: "0 0 32px hsl(220 90% 60% / 0.3)",
            }}>
            ...
            <a
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = "0 0 20px hsl(220 90% 60% / 0.3)";
              }}
              onMouseLeave={e => {
