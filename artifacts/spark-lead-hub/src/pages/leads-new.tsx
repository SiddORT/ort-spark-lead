...
const focusStyle: React.CSSProperties = {
  ...
  boxShadow: "0 0 0 3px hsl(197 100% 46% / 0.12), 0 0 8px hsl(197 100% 46% / 0.1)",
};
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: "var(--teal)",
            borderRadius: 2,
            boxShadow: "0 0 12px hsl(197 100% 46% / 0.5)",
            flexShrink: 0,
          }} />
          <div>
            <h1 style={{
              ...
              <div style={{ display: "flex", gap: "var(--space-2)", alignItems: "flex-start" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "hsl(197 100% 46% / 0.08)",
                    border: "1px solid hsl(197 100% 46% / 0.3)",
                    borderRadius: "var(--radius-md)",
                    color: "var(--teal)",
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = "hsl(197 100% 46% / 0.15)"; e.currentTarget.style.borderColor = "hsl(197 100% 46% / 0.5)"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "hsl(197 100% 46% / 0.08)"; e.currentTarget.style.borderColor = "hsl(197 100% 46% / 0.3)"; }}
                >
                  + Add
                </button>
              </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                background: createLead.isPending ? "hsl(197 100% 46% / 0.6)" : "var(--teal)",
                color: "hsl(222 22% 6%)",
                border: "none",
                borderRadius: "var(--radius-md)",
                fontSize: "var(--text-sm)",
                ...
                boxShadow: primaryHover && !createLead.isPending ? "0 0 20px hsl(197 100% 46% / 0.3)" : "none",
      ...
      {showServiceModal && (
        ...
        >
          <div style={{
            ...
            border: "1px solid var(--border-subtle)",
            borderRadius: "var(--radius-xl)",
            boxShadow: "0 32px 64px hsl(222 22% 3% / 0.6), 0 0 0 1px hsl(197 100% 46% / 0.08)",
            overflow: "hidden",
          }}>
            {/* Modal header */}
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
                <div style={{
                  ...
                  background: "hsl(197 100% 46% / 0.12)",
                  border: "1px solid hsl(197 100% 46% / 0.25)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                      ...
                      return (
                        <label
                          ...
                          style={{
                            ...
                            background: checked ? "hsl(197 100% 46% / 0.08)" : "transparent",
                          }}
                          onMouseEnter={e => { if (!checked) e.currentTarget.style.background = "var(--bg-elevated)"; }}
                          onMouseLeave={e => { e.currentTarget.style.background = checked ? "hsl(197 100% 46% / 0.08)" : "transparent"; }}
                        >
                          <input
                            type="checkbox"
                            checked={checked}
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  background: savingService ? "hsl(197 100% 46% / 0.6)" : "var(--teal)",
