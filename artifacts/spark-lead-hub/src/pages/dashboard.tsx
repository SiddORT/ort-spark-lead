            ...
            <AreaChart data={trendData}>
              <defs>
                <linearGradient id="tealGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%"  stopColor="hsl(197 100% 46%)" stopOpacity={0.3} />
                  <stop offset="95%" stopColor="hsl(197 100% 46%)" stopOpacity={0} />
                </linearGradient>
              </defs>
              ...
              <Tooltip
                ...
                content={<AreaTooltip />}
              />
              <Area type="monotone" dataKey="count" stroke="hsl(197 100% 46%)" strokeWidth={2.5} fillOpacity={1} fill="url(#tealGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
            ...
            <div ref={legendBtnRef} style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  height: 28,
                  padding: "0 10px",
                  background: showLegendPopover ? "hsl(197 100% 46% / 0.12)" : "transparent",
                  border: `1px solid ${showLegendPopover ? "hsl(197 100% 46% / 0.4)" : "var(--border-default)"}`,
                ...
                onMouseEnter={e => {
                  if (!showLegendPopover) {
                    e.currentTarget.style.background = "hsl(197 100% 46% / 0.06)";
                    e.currentTarget.style.borderColor = "hsl(197 100% 46% / 0.25)";
        ...
        <div style={{ position: "relative", flex: "1 1 200px", minWidth: 180 }}>
          ...
          <input
            ...
            onFocus={e => {
              ...
              e.currentTarget.style.boxShadow   = "0 0 0 3px hsl(197 100% 46% / 0.12), 0 0 8px hsl(197 100% 46% / 0.12)";
            }}
            onBlur={e => {
              e.currentTarget.style.borderColor = "var(--border-default)";
