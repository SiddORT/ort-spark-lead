          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: "var(--space-5)", marginBottom: "var(--space-8)" }}>
            ...
            <div style={{ position: "relative", flexShrink: 0 }}>
              <div style={{
                ...
                background: avatarPreview ? "transparent" : "hsl(197 100% 46% / 0.15)",
                border: `2px solid ${ACCENT}`,
                boxShadow: `0 0 0 4px hsl(197 100% 46% / 0.12)`,
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: "var(--space-2)" }}>
                <button
                  ...
                  onMouseEnter={e => e.currentTarget.style.background = "hsl(197 100% 46% / 0.18)"}
                  onMouseLeave={e => e.currentTarget.style.background = "hsl(197 100% 46% / 0.1)"}
                >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-5)" }}>
            ...
            <div>
              ...
              <input
                ...
                onFocus={e => { e.target.style.borderColor = ACCENT; e.target.style.boxShadow = "0 0 0 3px hsl(197 100% 46% / 0.12)"; }}
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "var(--space-2)" }}>
                <span style={{
                  ...
                  background: BADGE_BG[role] ?? "hsl(197 100% 46% / 0.12)",
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                background: (!isDirty || saving) ? "hsl(197 100% 46% / 0.5)" : ACCENT,
